...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <thead>
                                    ...
                                    <form name="frmChange" method="post" action ="addcat">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" placeholder="Enter category name" name="catName" id="cat_name"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" placeholder="Class Name" name="className" value=""></td>
